characters = [
    ...
    },
    {
      ...
      "damage"  : 11,
      "dmgInc"  : 8,
      "avatar"  : "./assets/images/darthmal.gif"
    },
    {
      "id"      : 3,
      "name"    : "Darthvader",
      ...
      "damage"  : 18,
      "dmgInc"  : 5,
      "avatar"  : "./assets/images/darthvadeer.gif"
    }
    ];
    ...
    function renderGameOver(w) {
      ...
      if(w) {
        $("#showcase h4.hp").text("Jedi Master!");
        $("#gameOver #message").html("You killed EVERYONE!. You now control the universe. You are clearly a master of the force.");
      } else {
    ...
    function gameWin() {
      console.log("You are a true jedi master!");
