$(document).ready(function() {
  ...
  var characters = {
    ...
    "Morty": {
      ...
      health: 8000,
      attack: 600,
      imageUrl: "assets/images/Morty.jpg",
      enemyAttackBack: 5
    },
    "Jerry": {
      name: "Jerry",
    ...
    "Mr. Poopy Butthole": {
      ...
      health: 180,
      attack: 7,
      imageUrl: "assets/images/MrPoopyButthole.jpg",
      enemyAttackBack: 25
    }
  };
  ...
  $("#attack-button").on("click", function() {
    if ($("#defender").children().length !== 0) {
      ...
      if (defender.health > 0) {
        ...
        $("#defender").empty();
        var gameStateMessage = "You have defeated " + defender.name + ", you can choose to destroy another enemy.";
        ...
        if (killCount >= combatants.length) {
          clearMessage();
          $("#attack-button").off("click");
          restartGame("You Won!!!! WUBALUBA DUB DUB!!!");
        }
      }
      turnCounter++;
    }
      ...
      clearMessage();
      renderMessage("None Were Worthy For You.");
    }
  });
});
